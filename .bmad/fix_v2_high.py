#!/usr/bin/env python3
"""
修复 system_evolution_v2.py 的 HIGH 问题
"""

import re
from pathlib import Path

FILE_PATH = Path("/root/.openclaw/workspace/second-brain-processor/system_evolution_v2.py")
...
def add_null_checks(content):
    ...
    target_functions = {
        ...
        'analyze_error_root_cause': ['error'],
        'generate_improvement_plan': ['errors', 'improvement_type'],
        'check_python_syntax': ['file_path'],
        'check_critical_paths': ['paths'],
...
def main():
    ...
    # 步骤 2：添加异常处理
    print("✅ 步骤 2：添加 IO 和 subprocess 异常处理...")
